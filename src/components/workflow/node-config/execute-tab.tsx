...
${workflow!.description ? `tool-description: ${workflow!.description}` : ""}`,
  ...
  const handleClick = async () => {
    ...
    if (failSchema) {
      return toast.warning(t("isEmpty", { name: failSchema[0] }));
    }
    ...
    <div className="fade-300 w-sm h-[85vh] bg-card border rounded-lg shadow-lg overflow-y-auto py-4">
      <div className="flex flex-col px-4">
        <div className="flex items-center gap-2 w-full h-9">
          <span className="font-semibold">{t("testRun")}</span>
          <div
            className={cn(
                  ...
                  <div key={key ?? i}>
                    ...
                    {schema.type == "number" ? (
                      <Input
                        ...
                        id={key || String(i)}
                        type="number"
                        placeholder={schema.description || t("placeholderNumber")}
                      ...
                      >
                        ...
                        >
                          <SelectValue
                            placeholder={
                              schema.description || t("placeholderOption")
                            }
                          />
                        </SelectTrigger>
                        <SelectContent>
                      ...
                      <Textarea
                        ...
                        placeholder={schema.description || t("placeholderString")}
                        onChange={(e) =>
        ...
        <div>
                  ...
                  >
                    ...
                    {history.status == "running" ? (
                      <TextShimmer className="font-semibold">
                        {t("nodeRunning", { name: history.name })}
                      </TextShimmer>
                    ) : (
          ...
          <div className="px-4 py-4">
            <div className="flex items-center mb-4">
              <p className="font-semibold text-sm">{t("resultTab")}</p>
