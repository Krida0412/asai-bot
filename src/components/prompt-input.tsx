        ...
        <fieldset className="flex w-full min-w-0 max-w-full flex-col px-4">
          ...
          >
            ...
            <div className="flex flex-col gap-3.5 px-5 pt-2 pb-4">
              ...
              <div className="flex w-full items-center z-30 gap-1">
                <input
                  ref={fileInputRef}
                  type="file"
                  accept=".pdf,.txt,.md,.csv,.json,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.zip,.rar,.7z,.tar,.gz,.mp3,.wav,.m4a,.ogg,.mp4,.webm,.mov"
                  multiple
                  className="hidden"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      size={"sm"}
                      className="rounded-full hover:bg-input! p-2!"
                      disabled={modelInfo?.isImageInputUnsupported || !canUploadImages || !threadId}
                          ...
                          <div className="flex gap-2 items-center">
                            {isSummarizable && (
                              <Tooltip>
                                ...
                                <TooltipContent>{t("summarize")}</TooltipContent>
                              </Tooltip>
                            )}
                            <Button
                              variant="ghost"
