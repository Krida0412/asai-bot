...
export const WORKER_SPRITES: WorkerSpriteConfig[] = [
  ...
  { key: "character_07", path: "/characters/Premade_Character_48x48_07.png", label: "Frank" },
  { key: "character_08", path: "/characters/Premade_Character_48x48_08.png", label: "Grace" },
  { key: "character_01", path: "/characters/Premade_Character_48x48_01.png", label: "Henry" },
];
