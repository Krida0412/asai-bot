...
export class WorkerManager {
  ...
  syncWorkers(seats: SeatState[], clearNearest: (w: Worker) => void) {
    console.log("WorkerManager: syncWorkers called with", seats.length, "seats. Currently have", this.workers.length, "workers.");
